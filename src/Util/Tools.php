...
class Tools
{
     ...
     * @var array
     */
    public static array $cache_callable = [
        'set' => null, // 写入缓存
        'get' => null, // 获取缓存
        'del' => null, // 删除缓存
        'put' => null, // 写入文件
     ...
     * @var array
     */
    private static array $cache_curl = [];
     ...
     * @return array|false
     */
    public static function xml3arr(string $xml)
    {
     ...
     * @return boolean|string
     */
    public static function doRequest(string $method, string $url, array $options = [])
    {
        $curl = curl_init();
        // GET参数设置
